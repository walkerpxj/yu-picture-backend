...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser> implements SpaceUserService {
    ...
    public SpaceUserVO getSpaceUserVO(SpaceUser spaceUser, HttpServletRequest request) {
        ...
        if (spaceId != null && spaceId > 0) {
            ...
            if (space != null && space.getUserId() != null && space.getUserId() > 0) {
    ...
    public List<SpaceUserVO> getSpaceUserVOList(List<SpaceUser> spaceUserList) {
        ...
        Map<Long, List<Space>> spaceIdSpaceListMap = spaceMapper.selectBatchIds(spaceIdSet).stream()
    ...
    @Override
    public SpaceUser getBySpaceIdAndUserId(Long spaceId, Long userId) {
