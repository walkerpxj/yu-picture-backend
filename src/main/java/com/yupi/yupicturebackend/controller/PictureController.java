...
public class PictureController {
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
        ...
        if (spaceId == null) {
            ...
            boolean hasPermission = loginUser.getId().equals(space.getUserId());
            if (!hasPermission && SpaceTypeEnum.TEAM.getValue() == space.getSpaceType()) {
                hasPermission = spaceUserService.getBySpaceIdAndUserId(spaceId, loginUser.getId()) != null;
            }
            if (!hasPermission) {
